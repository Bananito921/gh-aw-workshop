...
- [Recovering When the Review Skill Is Not Applied](side-quest-13-05-skill-not-applied.md) — recovery checklist for confirming the skills directory is pushed and reinforcing the reviewer agent's instruction when a submitted review skips the `pr-review-standards` format; branches from [Step 14b](14b-pr-reviewer-workflow.md).
