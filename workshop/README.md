...
- [Pre-Flight Checks Before Your First Run](side-quest-08-02-preflight-check.md) — the two 60-second checks that catch the leading cause of `model-access-not-configured` failures: lock file freshness and billing-path permissions; branches from [Step 8](08-run-your-workflow.md).
