...
- [Pre-Flight Workflow Checks](side-quest-08-02-preflight-check.md) — two-minute checklist for confirming your lock file is current and your billing configuration matches it before triggering a run; branches from [Step 8](08-run-your-workflow.md).
