...
- [Pre-Flight Diagnostics Before Your First Run](side-quest-08-02-preflight-diagnostics.md) — two-check walkthrough for lock file freshness and billing configuration before you trigger your first workflow run; branches from [Step 8](08-run-your-workflow.md).
